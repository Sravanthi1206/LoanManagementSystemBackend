...
/**
 * RabbitMQ configuration for loan-service.
 * Defines exchange, queue, and binding for notification messages.
 */
@Configuration
public class RabbitMQConfig {
    ...
    public static final String NOTIFICATION_ROUTING_KEY = "notification.loan";
